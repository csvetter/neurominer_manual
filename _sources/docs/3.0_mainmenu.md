...
```{figure} Images/NM_start-screen.png
---
height: 400px
figclass: margin-caption
name: 3.0_NM_start-screen
---
**The main starting display of NeuroMiner.**
```
...
2   | [Set up NM parameter workspace](3.2_mainmenu_define_parameter_template)\
3   | [Initialize & manage analyses](3.3_mainmenu_initialize_delete_analyses)\
4   | [Preprocess features](3.4_mainmenu_preprocess_features)\
5   | [Train supervised classifiers](3.5_mainmenu_train_supervised_classifiers)\
6   | [Visualise classifiers](3.6_mainmenu_visualize_classifiers)\
7   | [Display training results](3.7_mainmenu_display_training_results)\
8   | [Generate master files](3.8_mainmenu_generate_master_files)\
9   | [Lock analyses and start NM application mode](3.9_mainmenu_OOCV_analysis)\
10  | Load NeuroMiner structure\
11  | Save NeuroMiner structure\
13  | Change working directory\
14  | [Investigate sample size](3.10_mainmenu_investigate_sample_size)\
14  | Utilities\
<== | Back/Quit\[Q\]
